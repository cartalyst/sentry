...
class PhalconCookie extends Injectable implements CookieInterface {
    ...
    public function setCookie($value, $lifetime, $path = null, $domain = null, $secure = null, $httpOnly = null)
    {
        ...
        $this->getDI('cookie')->set($this->getKey(), serialize($value), $lifetime, $path, $domain, $secure, $httpOnly);
    }
    ...
    {
        if ($this->getDI('cookie')->has($this->getKey())) {
            return $this->getDI('cookie')->get($this->getKey());
        }
    }
